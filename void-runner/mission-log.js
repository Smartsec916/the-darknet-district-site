...
(function(root){
 ...
 function active(s,C){const list=[],f=C.missionFlight({...s,destination:null});
  ...
  if(s.universe?.missionLogUnlocked&&!s.universe.completedObjectives.includes('meet-admin'))list.push({id:'meet-admin',title:'MEET ADMIN',objective:'Find Admin at The Darknet District, Sacramento',destination:'earth',interaction:'tdd'});
  return list;
 }
