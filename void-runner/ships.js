...
(function(root){
 const ships={
  ...
  ship3:{id:'ship3',name:'Spectre / 03',price:2500,hull:170,shield:55,recharge:10,shieldDelay:4.5,laser:1.7,fireRate:1.25,cockpit:'spectre',color:'#c99cff',audio:{frequency:32,wave:'sine',roughness:.035},missile:{capacity:14,damage:1.45,lock:.65,cooldown:.7},flight:{acceleration:21,braking:30,maxSpeed:35,pitchRate:1.4,yawRate:1.7,rollRate:1.5,angularAcceleration:6.5,angularDamping:9,inertia:.8,linearDamping:2.3,boost:3}}
 };
 const equipment={};
 ...
 function get(s){return ships[s.activeShip]||ships.starter;}
 const api={ships,equipment,defaults,get};if(typeof module!=='undefined')module.exports=api;else root.VoidShips=api;
})(globalThis);
